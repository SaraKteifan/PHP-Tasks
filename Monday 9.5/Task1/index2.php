<?php
// 1-In the next PHP exercise, you will request input from the user, then move the user's response from one file to another and do something with it.
...
echo "<h1> Your favorite city is ".$array["city"]."</h1>";
// print_r($array);
